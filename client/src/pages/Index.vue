<template>
  <q-page class="content-container">
    <h6>Welcome to the IOST Challenges</h6>
    <p class="content-container">Kakao’s global public blockchain project IOST is an enterprise-grade, service-centric
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-8">
                ...
                <p>Get started with this challenge to learn
                  the basic set-up with the IOST token.</p>
              </div>
            </div>
          </router-link>
        </div>
